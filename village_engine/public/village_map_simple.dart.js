// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.11.6.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1, t2, t3, t4, t5, villageMap,
        _s15_ = "#village-canvas",
        _s8_ = "village1",
        _s8_0 = "village2",
        _s8_1 = "village3";
      A.print("Initializing Dart Village Map for SRED Research Project...");
      t1 = A._setArrayType([], type$.JSArray_VillageNode);
      t2 = A._setArrayType([], type$.JSArray_Domicile);
      t3 = document;
      t4 = type$.CanvasElement;
      t5 = t4._as(t3.querySelector(_s15_));
      t3 = t4._as(t3.querySelector(_s15_)).getContext("2d");
      t3.toString;
      villageMap = new A.VillageMapSimple(t5, t3, t1, t2);
      B.JSArray_methods.add$1(t1, new A.VillageNode(_s8_, "Tech Village", 100, 0, 85));
      B.JSArray_methods.add$1(t1, new A.VillageNode(_s8_0, "Art Village", -50, 87, 72.5));
      B.JSArray_methods.add$1(t1, new A.VillageNode(_s8_1, "Science Village", -50, -87, 91.2));
      B.JSArray_methods.add$1(t2, new A.Domicile("Demo User Home", _s8_, 50, 50));
      B.JSArray_methods.add$1(t2, new A.Domicile("Artist Studio", _s8_0, -80, 60));
      B.JSArray_methods.add$1(t2, new A.Domicile("Science Lab", _s8_1, -80, -60));
      B.JSArray_methods.add$1(t2, new A.Domicile("Tech Hub", _s8_, 120, -30));
      villageMap._setupEventListeners$0();
      villageMap._isRunning = true;
      villageMap._animate$0(0);
      A.print("Dart Village Map initialized successfully!");
      A.print("Research Goals:");
      A.print("- Dart WasmGC performance analysis");
      A.print("- 3D spatial computing innovation");
      A.print("- P2P trust network algorithms");
      A.print("- SRED grant preparation");
    },
    VillageMapSimple: function VillageMapSimple(t0, t1, t2, t3) {
      var _ = this;
      _._canvas = t0;
      _._context = t1;
      _._nodes = t2;
      _._domiciles = t3;
      _._isRunning = false;
      _._currentView = "overview";
      _._selectedVillage = null;
    },
    VillageMapSimple__setupEventListeners_closure: function VillageMapSimple__setupEventListeners_closure(t0) {
      this.$this = t0;
    },
    VillageMapSimple__animate_closure: function VillageMapSimple__animate_closure(t0) {
      this.$this = t0;
    },
    VillageNode: function VillageNode(t0, t1, t2, t3, t4) {
      var _ = this;
      _.id = t0;
      _.name = t1;
      _.x = t2;
    ...
    Domicile: function Domicile(t0, t1, t2, t3) {
      var _ = this;
      _.name = t0;
      _.villageId = t1;
      _.x = t2;
  ...
  J.JSNumber.prototype = {
    toStringAsFixed$1(receiver, fractionDigits) {
      ...
      if (fractionDigits > 20)
        throw A.wrapException(new A.RangeError(0, 20, true, fractionDigits, "fractionDigits", "Invalid value"));
  ...
  A.VillageMapSimple.prototype = {
    _setupEventListeners$0() {
      var t1 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(this._canvas, "click", t1._eval$1("~(1)?")._as(new A.VillageMapSimple__setupEventListeners_closure(this)), false, t1._precomputed1);
    },
    _handleVillageClick$2(x, y) {
      var centerX, centerY, _i, village, dx, dy, radius, _this = this,
        t1 = _this._canvas,
        t2 = t1.width;
      t2.toString;
      centerX = t2 / 2;
      ...
      for (t1 = _this._nodes, t2 = t1.length, _i = 0; _i < t2; ++_i) {
        village = t1[_i];
        dx = x - (centerX + village.x);
        dy = y - (centerY + village.y);
        radius = 15 + village.reputation / 100 * 25;
        if (dx * dx + dy * dy <= radius * radius) {
          _this._selectedVillage = village;
          _this._currentView = "village";
          A.printString("Entering " + village.name + "...");
          break;
        }
      }
    },
    _handleDomicileClick$2(x, y) {
      var centerX, centerY, t3, _i, domicile, dx, dy, t4, _this = this,
        t1 = _this._canvas,
        t2 = t1.width;
      t2.toString;
      centerX = t2 / 2;
      ...
      if (x >= 20 && x <= 120 && y >= 20 && y <= 60) {
        _this._selectedVillage = null;
        _this._currentView = "overview";
        A.print("Returning to village overview...");
        return;
      }
      for (t1 = _this._domiciles, t2 = t1.length, t3 = _this._selectedVillage, _i = 0; _i < t2; ++_i) {
        domicile = t1[_i];
        if (domicile.villageId === t3.id) {
          dx = x - (centerX + domicile.x);
          dy = y - (centerY + domicile.y);
          t4 = dx >= -25 && dx <= 25 && dy >= -30 && dy <= 20;
        } else
          t4 = false;
        if (t4) {
          A.printString("Entering domicile: " + domicile.name);
          break;
        }
      }
    },
    _animate$0(_) {
      var t1, t2, t3, t4, gradient, _this = this;
      if (!_this._isRunning)
        return;
      t1 = _this._context;
      t2 = _this._canvas;
      ...
      t4 = t2.height;
      t4.toString;
      t1.clearRect(0, 0, t3, t4);
      t4 = t2.height;
      t4.toString;
      gradient = t1.createLinearGradient(0, 0, 0, t4);
      gradient.addColorStop(0, "#0f0f23");
      gradient.addColorStop(1, "#1a1a2e");
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, gradient);
      t4 = t2.width;
      t4.toString;
      t2 = t2.height;
      t2.toString;
      t1.fillRect(0, 0, t4, t2);
      t1 = _this._currentView;
      if (t1 === "overview")
        _this._renderOverview$0();
      else if (t1 === "village")
        _this._renderVillageInterior$0();
      t1 = window;
      t1.toString;
      t2 = type$.void_Function_num._as(new A.VillageMapSimple__animate_closure(_this));
    ...
    _renderOverview$0() {
      var t2, t3, t4, _i, node, t5, t6, x, y, radius, _this = this,
        _s7_ = "#ffffff",
        _s18_ = "rgba(0, 0, 0, 0.7)",
        _s15_ = "bold 14px Arial",
        _s7_0 = "#ffff00",
        t1 = _this._context;
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
      t1.font = "bold 24px Arial";
      t1.textAlign = "center";
      t2 = _this._canvas;
      t3 = t2.width;
      t3.toString;
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "The Village - P2P Trust Network", t3 / 2, 40);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#aaaaaa");
      t1.font = "14px Arial";
      t3 = t2.width;
      t3.toString;
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "Click on any village to enter \u2022 Dart WasmGC Research Project", t3 / 2, 65);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s18_);
      t1.fillRect(10, 90, 200, 120);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
      t1.font = _s15_;
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "Legend", 20, 110);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#00ff00");
      t1.font = "12px Arial";
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "\u25cf High Reputation (85%+)", 20, 135);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_0);
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "\u25cf Medium Reputation (70-84%)", 20, 155);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#ff6666");
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "\u25cf Low Reputation (<70%)", 20, 175);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "Circle size = Reputation level", 20, 195);
      for (t3 = _this._nodes, t4 = t3.length, _i = 0; _i < t3.length; t3.length === t4 || (0, A.throwConcurrentModificationError)(t3), ++_i) {
        node = t3[_i];
        t5 = t2.width;
        t5.toString;
        t6 = t2.height;
        ...
        t6 = node.reputation;
        radius = 15 + t6 / 100 * 25;
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, node.get$color(0));
        t1.beginPath();
        t1.arc(x, y, radius, 0, 6.283185307179586, false);
        t1.fill();
        B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, _s7_);
        t1.lineWidth = 3;
        t1.stroke();
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s18_);
        t5 = y - radius;
        t1.fillRect(x - 50, t5 - 40, 100, 20);
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
        t1.font = _s15_;
        t1.textAlign = "center";
        t1.fillText(node.name, x, t5 - 25);
        if (t6 >= 85)
          t5 = "#00ff00";
        else
          t5 = t6 >= 70 ? _s7_0 : "#ff6666";
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, t5);
        t1.font = "bold 12px Arial";
        t1.fillText("Reputation: " + B.JSNumber_methods.toStringAsFixed$1(t6, 1) + "%", x, y + radius + 20);
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_0);
        t1.font = "10px Arial";
        t1.fillText("Click to enter", x, y - 5);
      }
      _this._drawConnections$0();
      _this._drawOverviewInstructions$0();
    },
    _renderVillageInterior$0() {
      var t1, t2, t3, t4, centerX, _this = this,
        _s7_ = "#ffffff",
        _s6_ = "center";
      if (_this._selectedVillage == null)
        return;
      t1 = _this._context;
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
      t1.font = "bold 24px Arial";
      t1.textAlign = _s6_;
      t2 = _this._selectedVillage.name;
      t3 = _this._canvas;
      t4 = t3.width;
      t4.toString;
      B.CanvasRenderingContext2D_methods.fillText$3(t1, t2 + " - Interior View", t4 / 2, 40);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#333333");
      t1.fillRect(20, 20, 100, 40);
      B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, _s7_);
      t1.lineWidth = 2;
      t1.strokeRect(20, 20, 100, 40);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
      t1.font = "bold 14px Arial";
      t1.textAlign = _s6_;
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "\u2190 Back", 70, 45);
      t4 = t3.width;
      t4.toString;
      centerX = t4 / 2;
      t3 = t3.height;
      ...
      t1.lineWidth = 3;
      t1.beginPath();
      t1.arc(centerX, t3 / 2, 200, 0, 6.283185307179586, false);
      t1.stroke();
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
      t1.font = "bold 18px Arial";
      t1.textAlign = _s6_;
      B.CanvasRenderingContext2D_methods.fillText$3(t1, _this._selectedVillage.name + " Village", centerX, 100);
      t2 = _this._selectedVillage.reputation;
      if (t2 >= 85)
        t2 = "#00ff00";
      else
        t2 = t2 >= 70 ? "#ffff00" : "#ff6666";
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, t2);
      t1.font = "bold 16px Arial";
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "Reputation: " + B.JSNumber_methods.toStringAsFixed$1(_this._selectedVillage.reputation, 1) + "%", centerX, 130);
      _this._drawDomiciles$0();
      _this._drawInteriorInstructions$0();
    },
    _drawOverviewInstructions$0() {
      var instructionY, i, i0,
        instructions = ["Click on any village to enter and explore domiciles", "Each circle represents a village with its reputation score", "Lines show connections between villages", "Size indicates reputation level"],
        t1 = this._canvas,
        t2 = t1.height;
      t2.toString;
      instructionY = t2 - 120;
      t2 = this._context;
      B.CanvasRenderingContext2D_methods.set$fillStyle(t2, "rgba(0, 0, 0, 0.7)");
      t1 = t1.width;
      t1.toString;
      t2.fillRect(20, instructionY - 10, t1 - 40, 110);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t2, "#ffffff");
      t2.font = "bold 14px Arial";
      B.CanvasRenderingContext2D_methods.fillText$3(t2, "How to explore:", 30, instructionY + 15);
      for (t1 = instructionY + 35, i = 0; i < 4; i = i0) {
        B.CanvasRenderingContext2D_methods.set$fillStyle(t2, "#cccccc");
        t2.font = "12px Arial";
        i0 = i + 1;
        t2.fillText("" + i0 + ". " + instructions[i], 30, t1 + i * 20);
      }
    },
    _drawDomiciles$0() {
      var centerX, centerY, t3, _i, domicile, x, y, t4, _this = this,
        t1 = _this._canvas,
        t2 = t1.width;
      t2.toString;
      centerX = t2 / 2;
      ...
      t1.toString;
      centerY = t1 / 2;
      for (t1 = _this._domiciles, t2 = t1.length, t3 = _this._context, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        domicile = t1[_i];
        if (domicile.villageId !== _this._selectedVillage.id)
          continue;
        x = centerX + domicile.x;
        y = centerY + domicile.y;
        B.CanvasRenderingContext2D_methods.set$fillStyle(t3, "#8B4513");
        t4 = y - 10;
        t3.fillRect(x - 20, t4, 40, 30);
        B.CanvasRenderingContext2D_methods.set$fillStyle(t3, "#FF6B6B");
        t3.beginPath();
        t3.moveTo(x - 25, t4);
        t3.lineTo(x, y - 30);
        t3.lineTo(x + 25, t4);
        t3.closePath();
        t3.fill();
        B.CanvasRenderingContext2D_methods.set$fillStyle(t3, "#ffffff");
        t3.font = "10px Arial";
        t3.textAlign = "center";
        t3.fillText(domicile.name, x, y + 30);
      }
    },
    _drawInteriorInstructions$0() {
      var instructionY, i, i0,
        instructions = ["Click on any domicile to enter or manage it", "Each house represents a user's personal space", 'Click "Back" to return to village overview', "Create your own domicile in this village"],
        t1 = this._canvas,
        t2 = t1.height;
      t2.toString;
      instructionY = t2 - 120;
      ...
      B.CanvasRenderingContext2D_methods.set$fillStyle(t2, "#ffffff");
      t2.font = "bold 14px Arial";
      B.CanvasRenderingContext2D_methods.fillText$3(t2, "Inside the village:", 30, instructionY + 15);
      for (t1 = instructionY + 35, i = 0; i < 4; i = i0) {
        B.CanvasRenderingContext2D_methods.set$fillStyle(t2, "#cccccc");
        t2.font = "12px Arial";
        i0 = i + 1;
    ...
    _drawConnections$0() {
      var centerX, centerY, i, j, j0, t3, node1, node2,
        t1 = this._canvas,
        t2 = t1.width;
      t2.toString;
      centerX = t2 / 2;
      ...
      centerY = t1 / 2;
      t1 = this._context;
      B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, "rgba(255, 255, 255, 0.3)");
      t1.lineWidth = 1;
      for (t2 = this._nodes, i = 0; i < t2.length; i = j)
        for (j = i + 1, j0 = j; t3 = t2.length, j0 < t3; ++j0) {
          if (!(i < t3))
            return A.ioore(t2, i);
          node1 = t2[i];
          node2 = t2[j0];
          t1.beginPath();
          t1.moveTo(centerX + node1.x, centerY + node1.y);
          t1.lineTo(centerX + node2.x, centerY + node2.y);
          t1.stroke();
        }
    }
  };
  A.VillageMapSimple__setupEventListeners_closure.prototype = {
    call$1($event) {
      var t1, t2, t3, t4, t5, x, y;
      type$.MouseEvent._as($event);
      t1 = this.$this;
      t2 = t1._canvas.getBoundingClientRect();
      t2.toString;
      t3 = $event.clientX;
      t3.toString;
      t4 = $event.clientY;
      ...
      t2 = t1._currentView;
      if (t2 === "overview")
        t1._handleVillageClick$2(x, y);
      else if (t2 === "village")
        t1._handleDomicileClick$2(x, y);
    },
    $signature: 10
  };
  A.VillageMapSimple__animate_closure.prototype = {
    call$1(__wc0_formal) {
      A._asNum(__wc0_formal);
      return this.$this._animate$0(0);
    },
    $signature: 11
  };
  A.VillageNode.prototype = {
    get$color(_) {
      var t1 = this.reputation;
      if (t1 >= 90)
        return "#00ff00";
      if (t1 >= 75)
        return "#ffff00";
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.VillageMapSimple__setupEventListeners_closure, A.VillageMapSimple__animate_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "~(Event)", "~(MouseEvent)", "~(num)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CanvasGradient":"JavaScriptObject","HtmlDocument":"Node","Document":"Node","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JavaScriptObject":{"JSObject":[]},"LegacyJavaScriptObject":{"JSObject":[]},"JSArray":{"List":["1"],"JSObject":[],"Iterable":["1"]},"JSArraySafeToStringHook":{"SafeToStringHook":[]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"JSObject":[],"Iterable":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"AsyncError":{"Error":[]},"_Future":{"Future":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Event":{"JSObject":[]},"MouseEvent":{"Event":[],"JSObject":[]},"HtmlElement":{"Element":[],"EventTarget":[],"JSObject":[]},"AnchorElement":{"Element":[],"EventTarget":[],"JSObject":[]},"AreaElement":{"Element":[],"EventTarget":[],"JSObject":[]},"CanvasElement":{"Element":[],"EventTarget":[],"JSObject":[]},"CanvasRenderingContext2D":{"JSObject":[]},"DomException":{"JSObject":[]},"DomRectReadOnly":{"JSObject":[]},"Element":{"EventTarget":[],"JSObject":[]},"EventTarget":{"JSObject":[]},"FormElement":{"Element":[],"EventTarget":[],"JSObject":[]},"Node":{"EventTarget":[],"JSObject":[]},"SelectElement":{"Element":[],"EventTarget":[],"JSObject":[]},"UIEvent":{"Event":[],"JSObject":[]},"Window":{"EventTarget":[],"JSObject":[]},"_DomRect":{"JSObject":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]}}'));
  var string$ = {
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_Domicile: findType("JSArray<Domicile>"),
      JSArray_String: findType("JSArray<String>"),
      JSArray_VillageNode: findType("JSArray<VillageNode>"),
...
//# sourceMappingURL=village_map_simple.dart.js.map
