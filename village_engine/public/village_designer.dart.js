...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1, t2, t3, t4, t5, t6, designer,
        _s11_ = "residential",
        _s13_ = "#admin-canvas",
        _s10_ = "commercial";
      A.print("Initializing Village Designer...");
      t1 = A._setArrayType([], type$.JSArray_Building);
      t2 = A._setArrayType([], type$.JSArray_Road);
      t3 = A._setArrayType([], type$.JSArray_Zone);
      t4 = document;
      t5 = type$.CanvasElement;
      t6 = t5._as(t4.querySelector(_s13_));
      t4 = t5._as(t4.querySelector(_s13_)).getContext("2d");
      t4.toString;
      designer = new A.VillageDesigner(t6, t4, t1, t2, t3);
      designer._setupEventListeners$0();
      B.JSArray_methods.add$1(t3, new A.Zone(_s11_, 50, 50, 200, 150, "#4ECDC4"));
      B.JSArray_methods.add$1(t3, new A.Zone(_s10_, 300, 50, 180, 120, "#FF6B6B"));
      B.JSArray_methods.add$1(t3, new A.Zone("public", 150, 250, 220, 100, "#9333EA"));
      B.JSArray_methods.add$1(t2, new A.Road(100, 0, 100, 400, 20));
      B.JSArray_methods.add$1(t2, new A.Road(0, 200, 400, 200, 20));
      B.JSArray_methods.add$1(t1, new A.Building(_s11_, 80, 80, 30, 40));
      B.JSArray_methods.add$1(t1, new A.Building(_s10_, 320, 80, 40, 35));
      B.JSArray_methods.add$1(t1, new A.Building("public", 200, 280, 60, 50));
      designer._render$0();
      A.print("Village Designer initialized successfully!");
    },
    VillageDesigner: function VillageDesigner(t0, t1, t2, t3, t4) {
      var _ = this;
      _._canvas = t0;
      _._context = t1;
      _._buildings = t2;
      ...
      _._zones = t4;
      _._isDragging = false;
      _._dragEnd = _._dragStart = null;
    },
    VillageDesigner__setupEventListeners_closure: function VillageDesigner__setupEventListeners_closure(t0) {
      this.$this = t0;
    },
    VillageDesigner__setupEventListeners_closure0: function VillageDesigner__setupEventListeners_closure0(t0) {
      this.$this = t0;
    },
    VillageDesigner__setupEventListeners_closure1: function VillageDesigner__setupEventListeners_closure1(t0) {
      this.$this = t0;
    },
    VillageDesigner__deleteElement_closure: function VillageDesigner__deleteElement_closure(t0) {
      this.$this = t0;
    },
    VillageDesigner__deleteElement_closure0: function VillageDesigner__deleteElement_closure0(t0) {
      this.$this = t0;
    },
    VillageDesigner__deleteElement_closure1: function VillageDesigner__deleteElement_closure1(t0) {
      this.$this = t0;
    },
    Building: function Building(t0, t1, t2, t3, t4) {
      var _ = this;
      _.type = t0;
      _.x = t1;
      _.y = t2;
    ...
    Road: function Road(t0, t1, t2, t3, t4) {
      var _ = this;
      _.x1 = t0;
      _.y1 = t1;
      _.x2 = t2;
    ...
    Zone: function Zone(t0, t1, t2, t3, t4, t5) {
      var _ = this;
      _.id = t0;
      _.x = t1;
      _.y = t2;
  ...
  A.VillageDesigner.prototype = {
    _setupEventListeners$0() {
      var _this = this,
        ...
        t3 = t2._eval$1("~(1)?");
      t2 = t2._precomputed1;
      A._EventStreamSubscription$(t1, "mousedown", t3._as(new A.VillageDesigner__setupEventListeners_closure(_this)), false, t2);
      A._EventStreamSubscription$(t1, "mousemove", t3._as(new A.VillageDesigner__setupEventListeners_closure0(_this)), false, t2);
      A._EventStreamSubscription$(t1, "mouseup", t3._as(new A.VillageDesigner__setupEventListeners_closure1(_this)), false, t2);
    },
    _handleToolAction$0() {
      var t3, t4, x, y, width, height, _this = this,
        _s11_ = "residential",
        t1 = _this._dragStart,
        t2 = t1 != null;
      if (!t2 || _this._dragEnd == null)
        return;
      switch ("building") {
        case "building":
          t2 = t1.x;
          ...
          t3 = t3.y;
          y = Math.min(t1, t3);
          width = Math.abs(t4 - t2);
          height = Math.abs(t3 - t1);
          if (width > 10 && height > 10) {
            B.JSArray_methods.add$1(_this._buildings, new A.Building(_s11_, x, y, width, height));
            A.print("Added residential building at (" + A.S(x) + ", " + A.S(y) + ")");
          }
          break;
        case "road":
          if (t2 && _this._dragEnd != null) {
            ...
            t1 = t1.y;
            t3 = _this._dragEnd;
            B.JSArray_methods.add$1(_this._roads, new A.Road(t2, t1, t3.x, t3.y, 20));
            t3 = _this._dragStart;
            t1 = t3.x;
            t3 = t3.y;
            t2 = _this._dragEnd;
            A.print("Added road from (" + A.S(t1) + ", " + A.S(t3) + ") to (" + A.S(t2.x) + ", " + A.S(t2.y) + ")");
          }
          break;
        case "zone":
          t2 = t1.x;
          ...
          if (width > 20 && height > 20) {
            t1 = _this._zones;
            B.JSArray_methods.add$1(t1, new A.Zone("zone_" + (t1.length + 1), x, y, width, height, _this._getZoneColor$1(_s11_)));
            A.print("Added residential zone at (" + A.S(x) + ", " + A.S(y) + ")");
          }
          break;
        case "delete":
          _this._deleteElement$0();
          break;
      }
    },
    _deleteElement$0() {
      ...
      if (_this._dragStart == null)
        return;
      B.JSArray_methods.removeWhere$1(_this._buildings, new A.VillageDesigner__deleteElement_closure(_this));
      B.JSArray_methods.removeWhere$1(_this._roads, new A.VillageDesigner__deleteElement_closure0(_this));
      B.JSArray_methods.removeWhere$1(_this._zones, new A.VillageDesigner__deleteElement_closure1(_this));
    },
    _getZoneColor$1(type) {
      switch (type) {
        case "residential":
          return "#4ECDC4";
        case "commercial":
    ...
    _render$0() {
      var _i, zone, t4, t5, t6, t7, t8, road, t9, t10, t11, building, _this = this,
        _s7_ = "#ffffff",
        t1 = _this._context,
        t2 = _this._canvas,
        t3 = t2.width;
      ...
      _this._drawGrid$0();
      for (t2 = _this._zones, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, A.throwConcurrentModificationError)(t2), ++_i) {
        zone = t2[_i];
        t4 = zone.color;
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, t4);
        t1.globalAlpha = 0.3;
        t5 = zone.x;
        t6 = zone.y;
        t7 = zone.width;
        t8 = zone.height;
        t1.fillRect(t5, t6, t7, t8);
        t1.globalAlpha = 1;
        B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, t4);
        t1.lineWidth = 2;
        t1.strokeRect(t5, t6, t7, t8);
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
        t1.font = "12px Arial";
        t1.textAlign = "center";
        t1.fillText(zone.id, t5 + t7 / 2, t6 + t8 / 2);
      }
      for (t2 = _this._roads, t3 = t2.length, t4 = type$.JSArray_num, t5 = type$.List_num, _i = 0; _i < t2.length; t2.length === t3 || (0, A.throwConcurrentModificationError)(t2), ++_i) {
        road = t2[_i];
        B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, "#666666");
        t1.lineWidth = road.width;
        t1.lineCap = "round";
        t1.beginPath();
        t6 = road.x1;
        t7 = road.y1;
        ...
        t1.lineWidth = 2;
        t10 = t5._as(A._setArrayType([10, 10], t4));
        t11 = !!t1.setLineDash;
        t11.toString;
        if (t11)
          t1.setLineDash(t10);
        else {
          t11 = !!t1.webkitLineDash;
          t11.toString;
          if (t11)
            t1.webkitLineDash = t10;
        }
        t1.beginPath();
        t1.moveTo(t6, t7);
        t1.lineTo(t8, t9);
        t1.stroke();
        t6 = t5._as(A._setArrayType([], t4));
        t7 = !!t1.setLineDash;
        t7.toString;
        if (t7)
          t1.setLineDash(t6);
        else {
          t7 = !!t1.webkitLineDash;
          t7.toString;
          if (t7)
            t1.webkitLineDash = t6;
        }
      }
      for (t2 = _this._buildings, t3 = t2.length, _i = 0; _i < t2.length; t2.length === t3 || (0, A.throwConcurrentModificationError)(t2), ++_i) {
        building = t2[_i];
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, building.getColor$0());
        t4 = building.x;
        t5 = building.y;
        t6 = building.width;
        t7 = building.height;
        t1.fillRect(t4, t5, t6, t7);
        B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, _s7_);
        t1.lineWidth = 2;
        t1.strokeRect(t4, t5, t6, t7);
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#FF6B6B");
        t1.beginPath();
        t1.moveTo(t4 - 5, t5);
        t8 = t4 + t6 / 2;
        t1.lineTo(t8, t5 - 15);
        t1.lineTo(t4 + t6 + 5, t5);
        t1.closePath();
        t1.fill();
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, _s7_);
        t1.font = "10px Arial";
        t1.textAlign = "center";
        t1.fillText(building.type, t8, t5 + t7 / 2);
      }
      if (_this._isDragging && _this._dragStart != null && _this._dragEnd != null)
        _this._drawToolPreview$0();
      _this._drawUIOverlay$0();
    },
    _drawGrid$0() {
      var t2, x, t3, y,
        t1 = this._context;
      B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, "rgba(255, 255, 255, 0.1)");
      t1.lineWidth = 1;
      t2 = this._canvas;
      x = 0;
      for (;;) {
    ...
    _drawToolPreview$0() {
      var t2, t3, t4, t5, t6, x, _this = this,
        t1 = _this._context;
      B.CanvasRenderingContext2D_methods.set$strokeStyle(t1, "#00ff88");
      t1.lineWidth = 2;
      t2 = type$.JSArray_num;
      B.CanvasRenderingContext2D_methods.setLineDash$1(t1, A._setArrayType([5, 5], t2));
      switch ("building") {
        case "building":
        case "zone":
          t3 = _this._dragStart;
          ...
          t3 = t3.y;
          t5 = t5.y;
          t1.strokeRect(x, Math.min(t3, t5), Math.abs(t6 - t4), Math.abs(t5 - t3));
          break;
        case "road":
          t1.beginPath();
          t3 = _this._dragStart;
      ...
      B.CanvasRenderingContext2D_methods.setLineDash$1(t1, A._setArrayType([], t2));
    },
    _drawUIOverlay$0() {
      var tools, i, t2,
        t1 = this._context;
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "rgba(0, 0, 0, 0.7)");
      t1.fillRect(10, 10, 150, 120);
      B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "#ffffff");
      t1.font = "bold 12px Arial";
      t1.textAlign = "left";
      B.CanvasRenderingContext2D_methods.fillText$3(t1, "Tools:", 20, 30);
      tools = ["Building", "Road", "Zone", "Delete"];
      for (i = 0; i < 4; ++i) {
        t2 = tools[i];
        B.CanvasRenderingContext2D_methods.set$fillStyle(t1, "building" === t2.toLowerCase() ? "#00ff88" : "#ffffff");
        t1.fillText(t2, 20, 50 + i * 20);
      }
    }
  };
  A.VillageDesigner__setupEventListeners_closure.prototype = {
    call$1($event) {
      var t1, t2, t3, t4, t5;
      ...
      t2 = t2.top;
      t2.toString;
      t1._dragStart = new A.Point(t3 - t5, t4 - t2, type$.Point_num);
      t1._isDragging = true;
    },
    $signature: 1
  };
  A.VillageDesigner__setupEventListeners_closure0.prototype = {
    call$1($event) {
      var t1, t2, t3, t4, t5;
      type$.MouseEvent._as($event);
      t1 = this.$this;
      ...
      t2 = t2.top;
      t2.toString;
      t1._dragEnd = new A.Point(t3 - t5, t4 - t2, type$.Point_num);
      t1._render$0();
    },
    $signature: 1
  };
  A.VillageDesigner__setupEventListeners_closure1.prototype = {
    call$1($event) {
      var t1, t2, t3, t4, t5;
      type$.MouseEvent._as($event);
      t1 = this.$this;
      ...
      t2.toString;
      t1._dragEnd = new A.Point(t3 - t5, t4 - t2, type$.Point_num);
      t1._handleToolAction$0();
      t1._isDragging = false;
    },
    $signature: 1
  };
  A.VillageDesigner__deleteElement_closure.prototype = {
    call$1(building) {
      var t1, t2, t3, t4;
      type$.Building._as(building);
      t1 = this.$this._dragStart;
      t2 = t1.x;
      t1 = t1.y;
      t3 = building.x;
      t4 = false;
      if (t2 >= t3)
        if (t2 <= t3 + building.width) {
          t2 = building.y;
          t1 = t1 >= t2 && t1 <= t2 + building.height;
        } else
          t1 = t4;
      else
        t1 = t4;
  ...
  A.VillageDesigner__deleteElement_closure0.prototype = {
    call$1(road) {
      var t1, t2, xx, yy, xx0, yy0, $C, $D, lenSq, param, dx, dy;
      type$.Road._as(road);
      t1 = this.$this._dragStart;
      t2 = t1.x;
      t1 = t1.y;
      ...
      $D = yy0 - yy;
      lenSq = $C * $C + $D * $D;
      param = lenSq !== 0 ? ((t2 - xx) * $C + (t1 - yy) * $D) / lenSq : -1;
      if (!(param < 0))
        if (param > 1) {
          yy = yy0;
          xx = xx0;
      ...
      dx = t2 - xx;
      dy = t1 - yy;
      return Math.sqrt(dx * dx + dy * dy) <= road.width;
    },
    $signature: 12
  };
  A.VillageDesigner__deleteElement_closure1.prototype = {
    call$1(zone) {
      var t1, t2, t3, t4;
      type$.Zone._as(zone);
      t1 = this.$this._dragStart;
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.VillageDesigner__setupEventListeners_closure, A.VillageDesigner__setupEventListeners_closure0, A.VillageDesigner__setupEventListeners_closure1, A.VillageDesigner__deleteElement_closure, A.VillageDesigner__deleteElement_closure0, A.VillageDesigner__deleteElement_closure1]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(MouseEvent)", "~(~())", "Null(@)", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "~(Event)", "bool(Building)", "bool(Road)", "bool(Zone)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","DomError":"JavaScriptObject","HtmlDocument":"Node","Document":"Node","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JavaScriptObject":{"JSObject":[]},"LegacyJavaScriptObject":{"JSObject":[]},"JSArray":{"List":["1"],"JSObject":[],"Iterable":["1"]},"JSArraySafeToStringHook":{"SafeToStringHook":[]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"JSObject":[],"Iterable":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"AsyncError":{"Error":[]},"_Future":{"Future":["1"]},"_Zone":{"Zone0":[]},"_RootZone":{"_Zone":[],"Zone0":[]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Event":{"JSObject":[]},"MouseEvent":{"Event":[],"JSObject":[]},"HtmlElement":{"Element":[],"EventTarget":[],"JSObject":[]},"AnchorElement":{"Element":[],"EventTarget":[],"JSObject":[]},"AreaElement":{"Element":[],"EventTarget":[],"JSObject":[]},"CanvasElement":{"Element":[],"EventTarget":[],"JSObject":[]},"CanvasRenderingContext2D":{"JSObject":[]},"DomException":{"JSObject":[]},"DomRectReadOnly":{"JSObject":[]},"Element":{"EventTarget":[],"JSObject":[]},"EventTarget":{"JSObject":[]},"FormElement":{"Element":[],"EventTarget":[],"JSObject":[]},"Node":{"EventTarget":[],"JSObject":[]},"SelectElement":{"Element":[],"EventTarget":[],"JSObject":[]},"UIEvent":{"Event":[],"JSObject":[]},"_DomRect":{"JSObject":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]}}'));
  var string$ = {
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      Building: findType("Building"),
      CanvasElement: findType("CanvasElement"),
      Error: findType("Error"),
      Event: findType("Event"),
      Function: findType("Function"),
      JSArray_Building: findType("JSArray<Building>"),
      JSArray_Road: findType("JSArray<Road>"),
...
//# sourceMappingURL=village_designer.dart.js.map
